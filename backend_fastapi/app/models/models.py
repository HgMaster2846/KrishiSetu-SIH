...
class MandiPriceModel(Base):
    ...
    source = Column(String(128), default='APMC Benchmark')
    arrival_date = Column(String(32), default='')
...
class CallLogModel(Base):
    ...
    session_state_json = Column(Text, default='{}')
    selected_buyer_id = Column(String(32), nullable=True)
    logistics_offer_json = Column(Text, default='{}')
    confirmation_state = Column(String(32), default='PENDING')
